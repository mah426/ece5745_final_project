...
#include "obj_dir_ProcXcel_null_rtl/VProcXcel_null_rtl.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcXcel_null_rtl/VProcXcel_null_rtl__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VProcXcel_null_rtl_t;

  // Exposed methods
  VProcXcel_null_rtl_t * create_model( const char * );
  void destroy_model( VProcXcel_null_rtl_t *);
  void comb_eval( VProcXcel_null_rtl_t * );
  void seq_eval( VProcXcel_null_rtl_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VProcXcel_null_rtl_t *, char * );
  #endif
...
VProcXcel_null_rtl_t * create_model( const char *vcd_filename ) {

  VProcXcel_null_rtl_t * m;
  VProcXcel_null_rtl   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VProcXcel_null_rtl_t *) malloc( sizeof(VProcXcel_null_rtl_t) );
  model = new VProcXcel_null_rtl();
  ...
  m->dmem___05Freqstream___05Fmsg = model->dmem___05Freqstream___05Fmsg;
  m->dmem___05Freqstream___05Frdy = &model->dmem___05Freqstream___05Frdy;
  m->dmem___05Freqstream___05Fval = &model->dmem___05Freqstream___05Fval;
  m->dmem___05Frespstream___05Fmsg = &model->dmem___05Frespstream___05Fmsg;
  m->dmem___05Frespstream___05Frdy = &model->dmem___05Frespstream___05Frdy;
  m->dmem___05Frespstream___05Fval = &model->dmem___05Frespstream___05Fval;
  m->imem___05Freqstream___05Fmsg = model->imem___05Freqstream___05Fmsg;
  m->imem___05Freqstream___05Frdy = &model->imem___05Freqstream___05Frdy;
  m->imem___05Freqstream___05Fval = &model->imem___05Freqstream___05Fval;
  m->imem___05Frespstream___05Fmsg = &model->imem___05Frespstream___05Fmsg;
  m->imem___05Frespstream___05Frdy = &model->imem___05Frespstream___05Frdy;
  m->imem___05Frespstream___05Fval = &model->imem___05Frespstream___05Fval;
  m->mngr2proc___05Fmsg = &model->mngr2proc___05Fmsg;
  m->mngr2proc___05Frdy = &model->mngr2proc___05Frdy;
  m->mngr2proc___05Fval = &model->mngr2proc___05Fval;
  m->proc2mngr___05Fmsg = &model->proc2mngr___05Fmsg;
  m->proc2mngr___05Frdy = &model->proc2mngr___05Frdy;
  m->proc2mngr___05Fval = &model->proc2mngr___05Fval;
  m->xmem___05Freqstream___05Fmsg = model->xmem___05Freqstream___05Fmsg;
  m->xmem___05Freqstream___05Frdy = &model->xmem___05Freqstream___05Frdy;
  m->xmem___05Freqstream___05Fval = &model->xmem___05Freqstream___05Fval;
  m->xmem___05Frespstream___05Fmsg = &model->xmem___05Frespstream___05Fmsg;
  m->xmem___05Frespstream___05Frdy = &model->xmem___05Frespstream___05Frdy;
  m->xmem___05Frespstream___05Fval = &model->xmem___05Frespstream___05Fval;
...
void destroy_model( VProcXcel_null_rtl_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcXcel_null_rtl * model = (VProcXcel_null_rtl *) m->model;
...
void comb_eval( VProcXcel_null_rtl_t * m ) {
...
void seq_eval( VProcXcel_null_rtl_t * m ) {
...
#if VLINETRACE
void trace( VProcXcel_null_rtl_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_ProcXcel_null_rtl__v );
