...
// At /home/mah426/ece5745/lab2-group11/sim/proc/Proc.py
...
// At /home/mah426/ece5745/lab2-group11/sim/lab2_xcel/SortXcel.py
...
`line 22 "lab2_xcel/SortXcel.v" 0
...
`line 24 "lab2_xcel/SortXcel.v" 0
`line 1 "vc/xcel-msgs.v" 0
//========================================================================
// xcel-msgs : Accelerator message type
//========================================================================
...
(
  	...
  	logic        result,      result_in;      //result = 1: accelerator finished
  	logic        swap_flag,   swap_flag_in;   //swap_flag = 1:swap a[i] and a[i+1]
  	logic        read1_flag_in, read2_flag_in, read3_flag_in, read4_flag_in, write0_flag_in, write1_flag_in, write2_flag_in;
	logic        read1_flag, read2_flag, read3_flag, read4_flag, write0_flag, write1_flag, write2_flag;

  	logic [10:0] mem_respstream_val_reg;
	
	logic [31:0] value_1,     value_1_in;
  	logic [31:0] value_2,     value_2_in;
  	logic [31:0] counter,     counter_in;
  	...
  	always @(posedge clk) begin
    	...
    	result      <= result_in;
    	swap_flag   <= swap_flag_in;
    	value_1     <= value_1_in;
    	value_2     <= value_2_in;
    	counter     <= counter_in;
		read1_flag	<= read1_flag_in;
		read2_flag	<= read2_flag_in;
		read3_flag	<= read3_flag_in;
		read4_flag	<= read4_flag_in;
		write0_flag	<= write0_flag_in;
		write1_flag	<= write1_flag_in;
		write2_flag	<= write2_flag_in;
		mem_respstream_val_reg = {mem_respstream_val_reg[9:0],mem_respstream_val};
  	end
	...
	begin
		...
		begin
    		...
    		STATE_XCFG:
    	  	    if ( go && xcel_respstream_rdy )
    	  	      	state_reg <= STATE_M_RD_START;

    	  	 STATE_M_RD_START:
				if ( mem_reqstream_rdy )
    	  	      	state_reg <= STATE_M_RD_1;

			STATE_M_RD_1:
				if (result)
    	  	      	state_reg <= STATE_XCFG;
				else if ( mem_reqstream_rdy && read1_flag_in )
					state_reg <= STATE_M_RD_2;

    	  	STATE_M_RD_2:
    	  	    if ( mem_reqstream_rdy && read2_flag_in ) 
    	  	      	state_reg <= STATE_M_RD_3;

    	  	STATE_M_RD_3:
				if ( mem_reqstream_rdy && read3_flag_in ) 
    	  	      	state_reg <= STATE_M_RD_4;
			...
			STATE_M_RD_4:
				...
				begin
    	  	    	...
    	  	    	begin
    	  	    	  	if( mem_reqstream_rdy ) 
    	  	    	    	state_reg <= STATE_M_WD_0;                
    	  	    	end
    	  	    	else if ( !swap_flag_in )   
    	  	    	  	state_reg <= STATE_M_RD_1;
				end

			STATE_M_WD_0:
    	  	    if( mem_reqstream_rdy && write0_flag_in )
    	  	      	state_reg <= STATE_M_WD_1;

    	  	STATE_M_WD_1:
    	  	    if( mem_reqstream_rdy && write1_flag_in )
    	  	      	state_reg <= STATE_M_WD_2;

    	  	STATE_M_WD_2:
    	  	    if ( write2_flag_in &&mem_reqstream_rdy )
    	  	      	state_reg <= STATE_M_RD_1;
  	...
  	always @(*) begin
		...
		//--------------------------------------------------------------------
  	  	// STATE: XCFG
  	  	//--------------------------------------------------------------------
  	  	else if ( state_reg == STATE_XCFG ) begin
  	  	  	xcel_reqstream_rdy = xcel_respstream_rdy;
  	  	  	xcel_respstream_val    = xcel_reqstream_val;
			
  	  	  	if ( xcel_reqstream_val ) 
				begin
  	  	  	  	// Send xcel response message, obviously you only want to
  	  	  	  	// send the response message when accelerator is done
				
  	  	  	  	if ( xcel_reqstream_msg.type_ == `VC_XCEL_REQ_MSG_TYPE_READ ) 
  	  	  	  	begin
					...
					begin
						...
						write2_flag_in  = 0;
  	  	  	  	  	...
  	  	  	  	  	else if ( xcel_reqstream_msg.addr == 1 )
  	  	  	  	  	  	base_src_in = xcel_reqstream_msg.data;
  	  	  	  	  	else if ( xcel_reqstream_msg.addr == 2 )
  	  	  	  	  	  	size_in = xcel_reqstream_msg.data;
		...
		else if ( state_reg == STATE_M_RD_START)
		begin
			mem_reqstream_val = 0;
		end
  	  	...
  	  	else if ( state_reg == STATE_M_RD_1 )
  	  	begin
			if( mem_respstream_val_reg[3:0] == 0 && !mem_respstream_val )
			begin
				read1_flag_in = 1;
  	  	  		mem_respstream_rdy = 1;
				write2_flag_in = 0;
  	  	  		read4_flag_in = 0;
  	  	  		mem_reqstream_val = 1;
  	  	  		mem_reqstream_msg_raw.type_ = `VC_MEM_REQ_MSG_TYPE_READ;
  	  	  		mem_reqstream_msg_raw.addr  = base_src + (idx << 2);
  	  	...
  	  	else if ( state_reg == STATE_M_RD_2 )
  	  	begin
  	  	  	mem_respstream_rdy = 1;
			read1_flag_in = 0;

  	  	  	if ( mem_respstream_val ) 
			begin
				value_1_in = mem_respstream_msg.data;
		  	  	mem_reqstream_val = 0;
  	  	  	  	read2_flag_in = 1;  
				read3_flag_in = 0;  
				read4_flag_in = 0;
 		...
 		//--------------------------------------------------------------------
		...
		else if ( state_reg == STATE_M_RD_3 )
  	  	begin
  	  	  	mem_respstream_rdy = 1;
			read2_flag_in = 0;
			...
			begin
				...
				read4_flag_in = 0;
  	  	  	  	...
  	  	  	  	mem_reqstream_msg_raw.type_ = `VC_MEM_REQ_MSG_TYPE_READ;
  	  	  	  	mem_reqstream_msg_raw.addr  = base_src + ((idx+1) << 2);
  	  	  	  	mem_reqstream_msg_raw.len   = 0;
  	  	  	end
  	  	...
  	  	else if ( state_reg == STATE_M_RD_4 )
  	  	begin
			write1_flag_in = 0;
			write2_flag_in = 0;
  	  	  	if ( mem_respstream_val && !read4_flag ) 
			begin
  	  	  	  	value_2_in = mem_respstream_msg.data;
  	  	  	  	read3_flag_in = 0; 
				read4_flag_in = 1;
				write0_flag_in = 0;
				
				mem_reqstream_val = 0;
  	  	  	  	// if value 2 < value, swap
  	  	  	  	if (value_2_in < value_1_in)
				begin    
  	  	  	  	  	swap_flag_in = 1;
  	  	  	  		// send write memory request
  	  	  	  	  	mem_reqstream_msg_raw.type_ = `VC_MEM_REQ_MSG_TYPE_WRITE;
  	  	  	  	  	mem_reqstream_msg_raw.addr  = base_src + (idx << 2);       
  	  	  	  	  	mem_reqstream_msg_raw.data  = value_2_in;
  	  	  	  	  	mem_reqstream_msg_raw.len   = 0;
  	  	  	  	end
  	  	  	  	else begin
  	  	  	  	  	swap_flag_in = 0;
  	  	  	  	...
  	  	  	  	idx_in = idx + 1;
  	  	  	  	if(idx >= size - counter -2) 
  	  	  	  	begin
  	  	  	  	  	counter_in = counter + 1;
  	  	  	  	  	if (!swap_flag_in) idx_in = 0;
  	  	  	  	  	if (counter >= size - 2) result_in  = 1;
  	  	  	  	end
  	  	  	end
  	  	end
  		...
  		//--------------------------------------------------------------------
		...
		else if ( state_reg == STATE_M_WD_0 )
  	  	begin
			if ( !mem_respstream_val ) 
			begin
				mem_reqstream_val = 1;
  	  	...
  	  	else if ( state_reg == STATE_M_WD_1 )
  	  	begin
  	  	  	read4_flag_in = 0;
  	  	  	mem_respstream_rdy = 1;
  	  	  	if ( mem_respstream_val ) 
			begin
				...
				write2_flag_in = 0;
  	  	  	  	...
  	  	  	  	mem_reqstream_msg_raw.type_ = `VC_MEM_REQ_MSG_TYPE_WRITE;
  	  	  	  	mem_reqstream_msg_raw.addr  = base_src + (idx << 2);
  	  	  	  	mem_reqstream_msg_raw.data  = value_1_in;
  	  	  	  	mem_reqstream_msg_raw.len   = 0;
  	  	  	end  	
  	  	end
  	  	...
  	  	else if ( state_reg == STATE_M_WD_2 )
  	  	begin
  	  	  	if ( mem_respstream_val ) 
			begin
				read1_flag_in = 0;
...
//----------------------------------------------------------------------
  	...
  	begin
    	...
    	case ( state_reg )
    	  	...
    	  	STATE_M_RD_START:        vc_trace.append_str( trace_str, "RS" );
			STATE_M_RD_1:			 vc_trace.append_str( trace_str, "R1" );
    	  	STATE_M_RD_2:            vc_trace.append_str( trace_str, "R2" );
			STATE_M_RD_3:			 vc_trace.append_str( trace_str, "R3" );
    		STATE_M_RD_4:			 vc_trace.append_str( trace_str, "R4" );
			STATE_M_WD_0:			 vc_trace.append_str( trace_str, "W0" );
    	  	STATE_M_WD_1:            vc_trace.append_str( trace_str, "W1" );
    	  	STATE_M_WD_2:            vc_trace.append_str( trace_str, "W2" );

    	  	default:                      vc_trace.append_str( trace_str, "? " );

    	endcase

    	// $sformat( str, "|%x|", swap_flag_in );
    	// vc_trace.append_str( trace_str, str );

    	// $sformat( str, "|%x|", base_src );
    	// vc_trace.append_str( trace_str, str );


    	// $sformat( str, "|%x|", mem_reqstream_msg_raw);
    	// vc_trace.append_str( trace_str, str );
	
    	// $sformat( str, "|%x|%x|", mem_reqstream_msg_raw.addr,mem_reqstream_msg_raw.data);
    	// vc_trace.append_str( trace_str, str );

    	// $sformat( str, "|%x|%x|", mem_reqstream_val,mem_respstream_rdy );
    	// vc_trace.append_str( trace_str, str );

    	// $sformat( str, "|%x|%x|%x|", mem_respstream_val,mem_reqstream_rdy,swap_flag_in );
    	// vc_trace.append_str( trace_str, str );

    	// $sformat( str, "|%x|%x|", idx_in, idx );
    	// vc_trace.append_str( trace_str, str );
    	// $sformat( str, "|%x|%x|", counter_in, counter );
    	// vc_trace.append_str( trace_str, str );

    	//request memory signals
    	$sformat( str, "|%x|%x|val_reg:%x|req_rdy:%x|  ", mem_reqstream_msg_raw.addr,mem_reqstream_msg_raw.data,mem_respstream_val_reg,mem_reqstream_rdy );
    	vc_trace.append_str( trace_str, str );
    	...
    	//receice memory data
    	$sformat( str, "|in:%x|req_val:%x|resp_vld:%x|", mem_respstream_msg.data,mem_reqstream_val,mem_respstream_val );
    	vc_trace.append_str( trace_str, str );

    	$sformat( str, "|%x|%x|", value_1_in, value_2_in );
    	vc_trace.append_str( trace_str, str );
    	vc_trace.append_str( trace_str, ")" );
...
// PyMTL Component ProcXcel Definition
// Full name: ProcXcel__ProcType_Proc__XcelType_SortXcel
// At /home/mah426/ece5745/lab2-group11/sim/pmx/ProcXcel.py

module ProcXcel_sort_rtl
(
  input  logic [0:0] clk ,
  output logic [0:0] commit_inst ,
  input  logic [0:0] reset ,
  output logic [0:0] stats_en ,
  output MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 dmem__reqstream__msg ,
  input logic [0:0] dmem__reqstream__rdy ,
  output logic [0:0] dmem__reqstream__val ,
  input MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 dmem__respstream__msg ,
  output logic [0:0] dmem__respstream__rdy ,
  input logic [0:0] dmem__respstream__val ,
  output MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 imem__reqstream__msg ,
  input logic [0:0] imem__reqstream__rdy ,
  output logic [0:0] imem__reqstream__val ,
  input MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 imem__respstream__msg ,
  output logic [0:0] imem__respstream__rdy ,
  input logic [0:0] imem__respstream__val ,
  input logic [31:0] mngr2proc__msg  ,
  output logic [0:0] mngr2proc__rdy  ,
  input logic [0:0] mngr2proc__val  ,
  output logic [31:0] proc2mngr__msg  ,
  input logic [0:0] proc2mngr__rdy  ,
  output logic [0:0] proc2mngr__val  ,
  output MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 xmem__reqstream__msg ,
  input logic [0:0] xmem__reqstream__rdy ,
  output logic [0:0] xmem__reqstream__val ,
  input MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 xmem__respstream__msg ,
  output logic [0:0] xmem__respstream__rdy ,
  input logic [0:0] xmem__respstream__val 
);
  //-------------------------------------------------------------
  // Component proc
  //-------------------------------------------------------------
  ...
  logic [0:0] proc_clk;
  logic [0:0] proc_commit_inst;
  logic [31:0] proc_core_id;
  logic [0:0] proc_reset;
  logic [0:0] proc_stats_en;
  MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 proc_dmem_reqstream_msg;
  logic [0:0] proc_dmem_reqstream_rdy;
  logic [0:0] proc_dmem_reqstream_val;
  MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 proc_dmem_respstream_msg;
  logic [0:0] proc_dmem_respstream_rdy;
  logic [0:0] proc_dmem_respstream_val;
  MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 proc_imem_reqstream_msg;
  logic [0:0] proc_imem_reqstream_rdy;
  logic [0:0] proc_imem_reqstream_val;
  MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 proc_imem_respstream_msg;
  logic [0:0] proc_imem_respstream_rdy;
  logic [0:0] proc_imem_respstream_val;
  logic [31:0] proc_mngr2proc_msg;
  logic [0:0] proc_mngr2proc_rdy;
  logic [0:0] proc_mngr2proc_val;
  logic [31:0] proc_proc2mngr_msg;
  logic [0:0] proc_proc2mngr_rdy;
  logic [0:0] proc_proc2mngr_val;
  XcelReqMsg__type__1__addr_5__data_32 proc_xcel_reqstream_msg;
  logic [0:0] proc_xcel_reqstream_rdy;
  logic [0:0] proc_xcel_reqstream_val;
  XcelRespMsg__type__1__data_32 proc_xcel_respstream_msg;
  logic [0:0] proc_xcel_respstream_rdy;
  logic [0:0] proc_xcel_respstream_val;
  ...
  (
    ...
    .reset( proc_reset ),
    .stats_en( proc_stats_en ),
    .dmem_reqstream_msg( proc_dmem_reqstream_msg ),
    .dmem_reqstream_rdy( proc_dmem_reqstream_rdy ),
    .dmem_reqstream_val( proc_dmem_reqstream_val ),
    .dmem_respstream_msg( proc_dmem_respstream_msg ),
    .dmem_respstream_rdy( proc_dmem_respstream_rdy ),
    .dmem_respstream_val( proc_dmem_respstream_val ),
    .imem_reqstream_msg( proc_imem_reqstream_msg ),
    .imem_reqstream_rdy( proc_imem_reqstream_rdy ),
    .imem_reqstream_val( proc_imem_reqstream_val ),
    .imem_respstream_msg( proc_imem_respstream_msg ),
    .imem_respstream_rdy( proc_imem_respstream_rdy ),
    .imem_respstream_val( proc_imem_respstream_val ),
    .mngr2proc_msg( proc_mngr2proc_msg ),
    .mngr2proc_rdy( proc_mngr2proc_rdy ),
    .mngr2proc_val( proc_mngr2proc_val ),
    .proc2mngr_msg( proc_proc2mngr_msg ),
    .proc2mngr_rdy( proc_proc2mngr_rdy ),
    .proc2mngr_val( proc_proc2mngr_val ),
    .xcel_reqstream_msg( proc_xcel_reqstream_msg ),
    .xcel_reqstream_rdy( proc_xcel_reqstream_rdy ),
    .xcel_reqstream_val( proc_xcel_reqstream_val ),
    .xcel_respstream_msg( proc_xcel_respstream_msg ),
    .xcel_respstream_rdy( proc_xcel_respstream_rdy ),
    .xcel_respstream_val( proc_xcel_respstream_val )
  );

  //-------------------------------------------------------------
  // End of component proc
  //-------------------------------------------------------------
  ...
  logic [0:0] xcel_clk;
  logic [0:0] xcel_reset;
  MemReqMsg__type__3__opaque_8__addr_32__len_2__data_32 xcel_mem_reqstream_msg;
  logic [0:0] xcel_mem_reqstream_rdy;
  logic [0:0] xcel_mem_reqstream_val;
  MemRespMsg__type__3__opaque_8__test_2__len_2__data_32 xcel_mem_respstream_msg;
  logic [0:0] xcel_mem_respstream_rdy;
  logic [0:0] xcel_mem_respstream_val;
  XcelReqMsg__type__1__addr_5__data_32 xcel_xcel_reqstream_msg;
  logic [0:0] xcel_xcel_reqstream_rdy;
  logic [0:0] xcel_xcel_reqstream_val;
  XcelRespMsg__type__1__data_32 xcel_xcel_respstream_msg;
  logic [0:0] xcel_xcel_respstream_rdy;
  logic [0:0] xcel_xcel_respstream_val;

  SortXcel_noparam xcel
  (
    .clk( xcel_clk ),
    .reset( xcel_reset ),
    .mem_reqstream_msg( xcel_mem_reqstream_msg ),
    .mem_reqstream_rdy( xcel_mem_reqstream_rdy ),
    .mem_reqstream_val( xcel_mem_reqstream_val ),
    .mem_respstream_msg( xcel_mem_respstream_msg ),
    .mem_respstream_rdy( xcel_mem_respstream_rdy ),
    .mem_respstream_val( xcel_mem_respstream_val ),
    .xcel_reqstream_msg( xcel_xcel_reqstream_msg ),
    .xcel_reqstream_rdy( xcel_xcel_reqstream_rdy ),
    .xcel_reqstream_val( xcel_xcel_reqstream_val ),
    .xcel_respstream_msg( xcel_xcel_respstream_msg ),
    .xcel_respstream_rdy( xcel_xcel_respstream_rdy ),
    .xcel_respstream_val( xcel_xcel_respstream_val )
  );

  //-------------------------------------------------------------
  // End of component xcel
  //-------------------------------------------------------------

  assign proc_clk = clk;
  assign proc_reset = reset;
  assign xcel_clk = clk;
  assign xcel_reset = reset;
  assign proc_core_id = 32'd0;
  assign xcel_xcel_reqstream_msg = proc_xcel_reqstream_msg;
  assign proc_xcel_reqstream_rdy = xcel_xcel_reqstream_rdy;
  assign xcel_xcel_reqstream_val = proc_xcel_reqstream_val;
  assign proc_xcel_respstream_msg = xcel_xcel_respstream_msg;
  assign xcel_xcel_respstream_rdy = proc_xcel_respstream_rdy;
  assign proc_xcel_respstream_val = xcel_xcel_respstream_val;
  assign proc_mngr2proc_msg = mngr2proc__msg;
  assign mngr2proc__rdy = proc_mngr2proc_rdy;
  assign proc_mngr2proc_val = mngr2proc__val;
  assign proc2mngr__msg = proc_proc2mngr_msg;
  assign proc_proc2mngr_rdy = proc2mngr__rdy;
  assign proc2mngr__val = proc_proc2mngr_val;
  assign imem__reqstream__msg = proc_imem_reqstream_msg;
  assign proc_imem_reqstream_rdy = imem__reqstream__rdy;
  assign imem__reqstream__val = proc_imem_reqstream_val;
  assign proc_imem_respstream_msg = imem__respstream__msg;
  assign imem__respstream__rdy = proc_imem_respstream_rdy;
  assign proc_imem_respstream_val = imem__respstream__val;
  assign dmem__reqstream__msg = proc_dmem_reqstream_msg;
  assign proc_dmem_reqstream_rdy = dmem__reqstream__rdy;
  assign dmem__reqstream__val = proc_dmem_reqstream_val;
  assign proc_dmem_respstream_msg = dmem__respstream__msg;
  assign dmem__respstream__rdy = proc_dmem_respstream_rdy;
  assign proc_dmem_respstream_val = dmem__respstream__val;
  assign xmem__reqstream__msg = xcel_mem_reqstream_msg;
  assign xcel_mem_reqstream_rdy = xmem__reqstream__rdy;
  assign xmem__reqstream__val = xcel_mem_reqstream_val;
  assign xcel_mem_respstream_msg = xmem__respstream__msg;
  assign xmem__respstream__rdy = xcel_mem_respstream_rdy;
  assign xcel_mem_respstream_val = xmem__respstream__val;
  assign stats_en = proc_stats_en;
