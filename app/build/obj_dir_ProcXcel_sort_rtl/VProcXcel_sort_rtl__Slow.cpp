...
void VProcXcel_sort_rtl::_settle__TOP__2(VProcXcel_sort_rtl__Syms* __restrict vlSymsp) {
    ...
    __Vtemp391[0U] = (IData)((QData)((IData)(vlTOPp->ProcXcel_sort_rtl__DOT__proc__DOT__v__DOT__dmem_reqstream_enq_msg_data)));
    __Vtemp391[1U] = ((0xfffffffcU & (vlTOPp->ProcXcel_sort_rtl__DOT__proc__DOT__v__DOT__dpath__DOT__alu_result_X 
                                      << 2U)) | (IData)(
                                                        ((QData)((IData)(vlTOPp->ProcXcel_sort_rtl__DOT__proc__DOT__v__DOT__dmem_reqstream_enq_msg_data)) 
                                                         >> 0x20U)));
    __Vtemp391[2U] = (3U & (vlTOPp->ProcXcel_sort_rtl__DOT__proc__DOT__v__DOT__dpath__DOT__alu_result_X 
                            >> 0x1eU));
    VL_EXTEND_WW(74,66, __Vtemp392, __Vtemp391);
...
void VProcXcel_sort_rtl::_ctor_var_reset() {
    ...
    ProcXcel_sort_rtl__DOT__xcel_mem_reqstream_val = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel_mem_respstream_rdy = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel_xcel_reqstream_rdy = VL_RAND_RESET_I(1);
    ...
    VL_RAND_RESET_W(77, ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__mem_reqstream_msg_raw);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__idx = VL_RAND_RESET_I(32);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__idx_in = VL_RAND_RESET_I(32);
    ...
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__result = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__result_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__swap_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__read1_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__read2_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__read3_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__read4_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__write0_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__write1_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__write2_flag_in = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__read4_flag = VL_RAND_RESET_I(1);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__mem_respstream_val_reg = VL_RAND_RESET_I(11);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__value_1_in = VL_RAND_RESET_I(32);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__value_2_in = VL_RAND_RESET_I(32);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__counter = VL_RAND_RESET_I(32);
    ProcXcel_sort_rtl__DOT__xcel__DOT__v__DOT__counter_in = VL_RAND_RESET_I(32);
    ...
    __Vchglast__TOP__ProcXcel_sort_rtl__DOT__xcel_xcel_respstream_val = VL_RAND_RESET_I(1);
}
